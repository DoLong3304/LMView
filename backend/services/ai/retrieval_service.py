...
from backend.services.ai.knowledge_service import compute_embedding

logger = logging.getLogger("backend.services.ai.retrieval_service")
...
def _build_retrieval_query(
    ...
    if AI_KB_APPROVED_ONLY or review_status == "approved":
        sql_parts.append(f"AND (s.review_status = 'approved' OR s.id IS NULL)")

"""
Write PostgreSQL daily news sentiment aggregates into Iceberg gold via Trino.
"""
...
HEADERS = {
    "X-Trino-User": "news-sentiment-writer",
...
async def main():
    ...
    for row in rows:
        ...
        """
        run_query(sql)
    logger.info("Wrote %d news sentiment aggregates", len(rows))

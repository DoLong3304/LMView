...
def create_spark_session():
    ...
    return SparkSession.builder \
        ...
        .config("spark.sql.catalog.iceberg_catalog.client.region", "ap-southeast-1") \
        .config("spark.sql.catalog.iceberg_catalog.s3.endpoint", "https://s3.ap-southeast-1.amazonaws.com") \

...
from common.config import AWS_ACCESS_KEY_ID as AWS_AK, AWS_SECRET_ACCESS_KEY as AWS_SK, AWS_REGION as AWS_R, S3_ENDPOINT
...
def build_spark():
    ...
    return (
        ...
        .config("spark.sql.catalog.iceberg_catalog.client.region",        AWS_R)
